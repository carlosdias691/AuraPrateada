...
<body>
    ...
    <script>
        ...
        // Configuração do botão do PayPal

        // Configuração do botão do PayPal
        function configurarPaypal() {
            const total = carregarItensCarrinho(); // Carrega os itens e o total
        ...
        // Carregar itens e configurar o PayPal quando a página é carregada
